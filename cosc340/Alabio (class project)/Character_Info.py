...
class characterWindow(QMainWindow):
    def __init__(self):
        ...
        self.nameText.setFont(QFont("Fantasy", 14))
        ...
        self.ageText.setFont(QFont("Fantasy", 14))
        ...
        self.sexText.setFont(QFont("Fantasy", 14))
        ...
        self.relationText.setFont(QFont("Fantasy", 14))
        ...
        self.jobText.setFont(QFont("Fantasy", 14))
        ...
        self.miscText.setFont(QFont("Fantasy", 14))
        ...
        self.descriptionText.setFont(QFont("Fantasy", 14))
    ...
    def saveNew(self):
        ...
        if not os.path.isdir("characterSaves"):
            mkdir("characterSaves")
    ...
    def saveOld(self):
        ...
        directory = "characterSaves/" + self.filename
    ...
    def loadFolder(self):
        ...
        directory = QFileDialog.getExistingDirectory(self, "Select character's name in " + '"characterSaves"', "characterSaves")
