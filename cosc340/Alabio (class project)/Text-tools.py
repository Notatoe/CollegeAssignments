'''
    Implementation of text tools

    This implements extra tools for text
    This includes font, font size, word color, and highlighting

    the feature also adds underlines and striking
'''
