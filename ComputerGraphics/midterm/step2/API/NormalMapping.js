// Function takes in vertexData and textureData to calculate tangents
...
// Function takes in vertexData and textureData to calculate bitangents
function GetBitangents(vertexData, textureData)
{
    var bitangents = [];
    for(let i = 0; i < vertexData.length; i += 9)
        {
