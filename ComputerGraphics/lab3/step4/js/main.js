...
function initializeMyObject(vertSource, fragSource, objData) {
  ...
  // For step 4 of lab 3, makes a cube map
  var texture = gl.createTexture();
  gl.bindTexture(gl.TEXTURE_CUBE_MAP, texture);

  // Loads in each face for the cube map
  const faceInfos = [
  { face: gl.TEXTURE_CUBE_MAP_POSITIVE_X, picture: 'imagefiles/posx.jpg'},
  { face: gl.TEXTURE_CUBE_MAP_NEGATIVE_X, picture: 'imagefiles/negx.jpg'},
  { face: gl.TEXTURE_CUBE_MAP_POSITIVE_Y, picture: 'imagefiles/posy.jpg'},
  { face: gl.TEXTURE_CUBE_MAP_NEGATIVE_Y, picture: 'imagefiles/negy.jpg'},
  { face: gl.TEXTURE_CUBE_MAP_POSITIVE_Z, picture: 'imagefiles/posz.jpg'},
  { face: gl.TEXTURE_CUBE_MAP_NEGATIVE_Z, picture: 'imagefiles/negz.jpg'},];
