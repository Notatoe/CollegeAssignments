...
async function setupScene() {
  ...
  let vertSource = await loadNetworkResourceAsText('resources/shaders/verts/gouraud.vert');
  let fragSource = await loadNetworkResourceAsText('resources/shaders/frags/gouraud.frag');
...
function initializeMyObject(vertSource, fragSource, objData) {
  ...
  */
  ...
  //var reverseLightDirectionLocation = gl.getUniformLocation(myDrawable, );
