...
async function setupScene() {
  let objData = await loadNetworkResourceAsText('resources/models/bunny.obj');
  let vertSource = await loadNetworkResourceAsText('resources/shaders/verts/myShader.vert');
  let fragSource = await loadNetworkResourceAsText('resources/shaders/frags/myShader.frag');
